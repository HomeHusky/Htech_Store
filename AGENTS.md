...
This project is indexed by GitNexus as **Htech_Store** (2707 symbols, 4473 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
